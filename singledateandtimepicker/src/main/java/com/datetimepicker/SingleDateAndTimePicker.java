...
import com.datetimepicker.widget.WheelAmPmPicker;
import com.datetimepicker.widget.WheelDayPicker;
import com.datetimepicker.widget.WheelHourPicker;
import com.datetimepicker.widget.WheelMinutePicker;
import com.datetimepicker.widget.WheelPicker;
...
//        String displayed = DateFormat.format(format, date).toString();
        ...
        if (DateUtils.isToday(date.getTime())) {
            simpleDateFormat = new SimpleDateFormat("HH:mm", Locale.forLanguageTag("vi"));
            displayed = "Hôm nay, " + simpleDateFormat.format(date);
        } else {
            simpleDateFormat = new SimpleDateFormat("EEE d MMM, HH:mm", Locale.forLanguageTag("vi"));
            displayed = simpleDateFormat.format(date);
        }
        if (listener != null) {
